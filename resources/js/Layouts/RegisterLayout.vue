			...
			>
				...
				<div class="w-80 rounded-lg bg-skin-white bg-opacity-30 p-8 lg:w-2/3">
					<h2 class="mb-2 text-2xl font-bold">
						{{ trans("layout.register.selected_plan") }}
					</h2>
					...
					>
						{{ trans("layout.register.change_plan") }}
					</Link>
				</div>
			</section>
					...
					<div class="mx-auto w-full max-w-md px-8 pb-20 sm:px-0">
						<div class="relative">
							...
							<ul class="relative flex w-full justify-between">
								<Stepper
									step-number="1"
									:step-name="trans('layout.register.step_1')"
								...
								<Stepper
									step-number="2"
									:step-name="trans('layout.register.step_2')"
								...
								<Stepper
									step-number="3"
									:step-name="trans('layout.register.step_3')"
