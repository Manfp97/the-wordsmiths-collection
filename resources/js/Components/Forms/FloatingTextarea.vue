...
<template>
	<div class="relative">
		<textarea
			...
			ref="$textarea"
			v-model="value"
			class="peer block w-full resize-y overflow-hidden rounded-lg p-4 text-sm shadow-sm placeholder:text-skin-transparent autofill:pb-2 autofill:pt-6 focus:pb-2 focus:pt-6 focus:ring-2 disabled:pointer-events-none disabled:opacity-50 [&:not(:placeholder-shown)]:pb-2 [&:not(:placeholder-shown)]:pt-6"
			:class="{
