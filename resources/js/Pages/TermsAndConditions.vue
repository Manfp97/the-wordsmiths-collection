			...
			<main class="mx-auto mb-20 mt-10 max-w-7xl sm:mb-32">
				<div class="mx-6 sm:mx-8 md:mx-10 lg:mx-12">
					...
					<p>
						...
						subject to, prevailing law of es. Any use of the above terminology
					...
					<p>
						We employ the use of cookies. By accessing The Wordsmith's
						Collection, you agreed to use cookies in agreement with the The
						Wordsmith's Collection's Privacy Policy.
					</p>
					...
					<p>
						...
						The Wordsmith's Collection. All intellectual property rights are
						reserved. You may access this from The Wordsmith's Collection for
					...
					<p>
						...
						The Wordsmith's Collection does not filter, edit, publish or review
						...
						permitted by applicable laws, The Wordsmith's Collection shall not
					...
					<p>
						The Wordsmith's Collection reserves the right to monitor all
					...
					<p>
						You hereby grant The Wordsmith's Collection a non-exclusive license
					...
					<p>
						...
						visibility of the hyperlink compensates the absence of The
						Wordsmith's Collection; and (d) the link is in the context of
