...
<template>
	...
	<Nav
		...
		description="The Wordsmith's Collection terms and conditions"
	/>
	...
	<div class="page-container">
		<main class="mx-auto mb-20 mt-10 max-w-7xl sm:mb-32">
			<div class="mx-6 sm:mx-8 md:mx-10 lg:mx-12">
				...
				<p>Welcome to The Wordsmith's Collection!</p>
				...
				<p>
					...
					conditions. Do not continue to use The Wordsmith's Collection if you
				...
				<p>
					...
					accordance with and subject to, prevailing law of es. Any use of the
				...
				<p>
					We employ the use of cookies. By accessing The Wordsmith's Collection,
					you agreed to use cookies in agreement with the The Wordsmith's
					Collection's Privacy Policy.
				</p>
				...
				<p>
					Unless otherwise stated, The Wordsmith's Collection and/or its
					licensors own the intellectual property rights for all material on The
					Wordsmith's Collection. All intellectual property rights are reserved.
					You may access this from The Wordsmith's Collection for your own
				...
				<p>You must not:</p>
				<ul>
					<li>Republish material from The Wordsmith's Collection</li>
					<li>
						Sell, rent or sub-license material from The Wordsmith's Collection
					</li>
					<li>
						Reproduce, duplicate or copy material from The Wordsmith's
						Collection
					</li>
					<li>Redistribute content from The Wordsmith's Collection</li>
				</ul>
				...
				<p>
					...
					Wordsmith's Collection does not filter, edit, publish or review
					Comments prior to their presence on the website. Comments do not
					reflect the views and opinions of The Wordsmith's Collection,its
					...
					by applicable laws, The Wordsmith's Collection shall not be liable for
				...
				<p>
					The Wordsmith's Collection reserves the right to monitor all Comments
				...
				<p>
					You hereby grant The Wordsmith's Collection a non-exclusive license to
				...
				<p>
					...
					the hyperlink compensates the absence of The Wordsmith's Collection;
				...
				<p>
					...
					sending an e-mail to The Wordsmith's Collection. Please include your
				...
				<p>
					No use of The Wordsmith's Collection's logo or other artwork will be
